...
public class AdapterDownload extends RecyclerView.Adapter<AdapterDownload.HistViewHolder> {
    ...
    AdapterDownload(List<Music> musics) {
    ...
    @Override
    public AdapterDownload.HistViewHolder onCreateViewHolder(ViewGroup parentViewGroup, int i) {
        ...
        return new AdapterDownload.HistViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final AdapterDownload.HistViewHolder histViewHolder, final int i) {
        histViewHolder.title.setText(wstr.normalizeString(musicList.get(i).getTitle()));
        histViewHolder.artist.setText(wstr.normalizeString(musicList.get(i).getArtist()));
