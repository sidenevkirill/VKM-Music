...
public class Login2faActivity extends AppCompatActivity {
    ...
    void getCode(String cookie) {
        progressDialog = new ProgressDialog(Login2faActivity.this, R.style.progressbart);
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Login2faActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        AlertDialog.Builder builder = new AlertDialog.Builder(Login2faActivity.this, R.style.AlertDialog);
...
//[1842,false,2,"\/login?act=authcheck_code&hash=1516823768_57e3d50b58c0a8dd72","\/captcha.php?sid=134509841382",{"captcha_sid":"134509841382","_ajax":"1","code":"801051","remember":"1"}]
                if (responseData.contains("login?role")) {
                    ...
                    tmpcookie = "remixttpid" + AudioUtil.pars("remixttpid", responseHead, ".com") + ".com";
                    getToken(tmpcookie, "https://m.vk.com/login" + AudioUtil.pars("login", responseData, "\""), "none");
                    ...
                    Login2faActivity.this.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Picasso.get()
                                    .load("https://m.vk.com/captcha.php?sid=" + AudioUtil.pars("\"captcha_sid\":\"", responseData, "\""))
                                    .into(captcha);
                            View.OnClickListener entercode = new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    TextInputEditText code1 = findViewById(R.id.code1);
                                    getContinue(cookie + " remixstid" + AudioUtil.pars("remixstid", responseHead, ".com") + ".com", "https://m.vk.com/login" + AudioUtil.pars("login", responseData, "\""), AudioUtil.pars("\"captcha_sid\":\"", responseData, "\""), code, code1.getText().toString());
                                }
                            };
                        ...
                        public void run() {
                            ...
                            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    Intent intent = new Intent(Login2faActivity.this, LoginActivity.class);
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, final Response response) throws IOException {
                ...
                if (responseHead.contains("/login?act=authcheck&m=442")) {
                    ...
                    cooks = cooks.substring(0, cooks.indexOf("remixauthcheck")) + AudioUtil.pars(";", AudioUtil.pars("remixauthcheck", cooks, ".com") + ".com", ".com") + ".com";
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, final Response response) throws IOException {
                ...
                if (responseHead.contains("remixsid")) {
                    ...
                    Intent intent = new Intent(Login2faActivity.this, AudioMainActivity.class);
                    startActivity(intent);
                    finish();
                } else {
                    Login2faActivity.this.runOnUiThread(new Runnable() {
