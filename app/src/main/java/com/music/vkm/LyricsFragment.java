...
public class LyricsFragment extends Fragment {
    ...
    public static LyricsFragment newInstance(String text) {

        LyricsFragment f = new LyricsFragment();
        Bundle b = new Bundle();
    ...
    void SetInfo(String art, String titl) {
        ...
        artist.setText(AudioUtil.normalizeString(art));

        title.setText(AudioUtil.normalizeString(titl));
                ...
                if (getActivity() != null)
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            // textView.setText(AudioUtil.pars("<!>0<!>",responseData,""));
