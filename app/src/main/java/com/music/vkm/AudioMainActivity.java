...
public class AudioMainActivity extends AppCompatActivity implements BillingProcessor.IBillingHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (loadText("sid").equals("")) {
            Intent newIntent = new Intent(AudioMainActivity.this, LoginActivity.class);
...
*/
            ...
            View.OnClickListener AdClick = new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(AudioMainActivity.this, AdActivity.class);
...
*/
    ...
    private void setupViewPagerPlayer(ViewPager viewPager) {
        ...
        adapter.addFragment(new MusicPlayerFragment(), getResources().getString(R.string.savedmusic));
        adapter.addFragment(new PlayListFragment(), getResources().getString(R.string.popular));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.ads:
                bp.purchase(AudioMainActivity.this, "15_coin");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                if (typePager == 0) {
                    MusicAdapter adapter = AudioListFragmentMy.adapter;
                    adapter.getFilter().filter(newText);
                    adapter = AudioListSaveFragment.adapter;
                    adapter.getFilter().filter(newText);
                } else if (typePager == 1) {
                    MusicAdapter adapter = AudioListRecommendationsFragment.adapter;
                    adapter.getFilter().filter(newText);
                    adapter = AudioListPopularFragment.adapter;
                    adapter.getFilter().filter(newText);
                }
    ...
    private void setupViewPagerDef(ViewPager viewPager) {
        AudioFragmentAdapter adapter = new AudioFragmentAdapter(getSupportFragmentManager());
        adapter.addFragment(new AudioListFragmentMy(), getResources().getString(R.string.mmusic));
        adapter.addFragment(new AudioListSaveFragment(), getResources().getString(R.string.savedmusic));
        adapter.addFragment(new AudioListRecommendationsFragment(), getResources().getString(R.string.popular));
        viewPager.setAdapter(adapter);
    ...
    public void setupViewPagerRec(ViewPager viewPager) {
        AudioFragmentAdapter adapter = new AudioFragmentAdapter(getSupportFragmentManager());
        adapter.addFragment(new AudioListPopularFragment(), getResources().getString(R.string.mmusic));
        adapter.addFragment(new AudioListSaveFragment(), getResources().getString(R.string.mmusic));
        viewPager.setAdapter(adapter);
        viewPager.setOffscreenPageLimit(3);
        typePager = 1;
        lastTypePager = 1;
    ...
    public void setupViewPagerSearch(ViewPager viewPager, String query) {
        AudioSearchFragment.query = query;
        AudioFragmentAdapter adapter = new AudioFragmentAdapter(getSupportFragmentManager());
        adapter.addFragment(new AudioSearchFragment(), getResources().getString(R.string.mmusic));
        viewPager.setAdapter(adapter);
        typePager = 2;
    }
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        switch (position) {
                            ...
                            case 6: {
                                Intent intent = new Intent(AudioMainActivity.this, InfoActivity.class);
                                startActivity(intent);
                                return false;
                            }
                            case 7: {
                                Intent intent = new Intent(AudioMainActivity.this, SettingsGeneralActivity.class);
                                startActivity(intent);
                                return false;
                            }
                            case 9: {
    ...
    void getInfo() {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                AudioMainActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        ViewPager viewpager_main = findViewById(R.id.viewpager_main);
                        viewpager_main.setCurrentItem(1);
            ...
            public void onResponse(Call call, final Response response) throws IOException {
                ...
                final String version = AudioUtil.pars("|VER|", responseData, "|");
                final String status = AudioUtil.pars("|STATUS|", responseData, "|");
                final String url = AudioUtil.pars("|URL|", responseData, "|");
                final String needhelp = AudioUtil.pars("|NEEDHELP|", responseData, "|");
                final String updateinfo = AudioUtil.pars("|UPDATEINFO|", responseData, "|");
                final String type_appodeal;
                final String typead;
                final String idAppodeal;
                final String addAppodeal = AudioUtil.pars("|addAppodeal|", responseData, "|");


                String info = AudioUtil.pars("|packageName|", responseData, "]|") + "]";

                String infoPackage = AudioUtil.pars(getPackageName() + ":[", info, "]");
                if (infoPackage.contains("typeAd")) {
                    type_appodeal = AudioUtil.pars("|typeappodeal|", infoPackage, "|");
                    typead = AudioUtil.pars("|typeAd|", infoPackage, "|");
                    idAppodeal = AudioUtil.pars("|idAppodeal|", infoPackage, "|");
                } else {
                    type_appodeal = AudioUtil.pars("|type_appodeal|", responseData, "|");
                    typead = AudioUtil.pars("|typead|", responseData, "|");
                    idAppodeal = AudioUtil.pars("|idAppodeal|", responseData, "|");
                }
                    ...
                    public void run() {
                        ...
                        if (respcode == 200) {
                            ...
                            if (versionCodeint > versionCode && (versionCodeint != 0)) {
                                if (!url.equals("none")) {
                                    AlertDialog.Builder builder = new AlertDialog.Builder(AudioMainActivity.this, R.style.AlertDialog);
