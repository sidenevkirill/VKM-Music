...
public class Music implements Serializable {
    ...
    public Music(String artist, String time, String url, String title, String lyrics_id, String pic, String data_id, String save, String your, String type, String add_hash, String del_hash, String res_hash) {
        this.artist = artist;
        this.url = url;
        this.title = title;
    ...
    void setFromString(String mus) {
        artist = AudioUtil.pars("|artist|", mus, "|");
        time = AudioUtil.pars("|time|", mus, "|");
        url = AudioUtil.pars("|url|", mus, "|");
        title = AudioUtil.pars("|title|", mus, "|");
        lyrics_id = AudioUtil.pars("|lyrics_id|", mus, "|");
        pic = AudioUtil.pars("|pic|", mus, "|");
        data_id = AudioUtil.pars("|id|", mus, "|");
        save = AudioUtil.pars("|save|", mus, "|");
    }
