...
public class MusicPlayerFragment extends Fragment {
    ...
    public static MusicPlayerFragment newInstance(String text) {
    ...
    public void onStart() {
        ...
        if (MusicService.mediaPlayer != null) {
            ...
            aplayer_title.setText(AudioUtil.normalizeString(MusicService.getSchedule().getCurrentMusic().getTitle()));
            aplayer_artist.setText(AudioUtil.normalizeString(MusicService.getSchedule().getCurrentMusic().getArtist()));
        ...
        if (getActivity() != null) {
            ...
            aplayer_progress.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                ...
                public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                    aplayer_time.setText(AudioUtil.millisecondsToTime(progress));
                    if (fromUser) {
                        MusicSeek(progress);
                    }
            ...
            public void onReceive(Context context, Intent intent) {
                if (intent.getAction().equals("com.mascotworld.vkaudiomanager.send")) {
                    if (getActivity() != null) {
                        ...
                        aplayer_duration.setText(AudioUtil.millisecondsToTime(time));
                        aplayer_title.setText(AudioUtil.normalizeString(intent.getStringExtra("title")));
                        aplayer_artist.setText(AudioUtil.normalizeString(intent.getStringExtra("artist")));
    ...
    void setSeek(int seek, int sseek) {
        ...
        final TextView aplayer_time = getActivity().findViewById(R.id.new_time);
        aplayer_time.setText(AudioUtil.millisecondsToTime(seek));
    }
