...
public class MusicAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
    ...
    public MusicAdapter(List<Music> datas, List<PlayList> playLists, int type) {
    ...
    public MusicAdapter(MusicSchedule schedule, List<PlayList> playLists, int type) {
        ...
        switch (holder.getItemViewType()) {
            case 0: {
                ...
                if (type == 4) {
                    ...
                    final PlaylistsAdapter playlistsAdapter = new PlaylistsAdapter(playLists);
                    playlistsAdapter.setOnItemClickListener(new OnItemClickListener() {
                        @Override
                        public void onItemClick(View itemView, int position) {

                        }
                    });
                    recPlaylists.setAdapter(playlistsAdapter);
            ...
            case 1: {
                ...
                if (i < musicList.size()) {
                    musicViewHolder.title.setText(AudioUtil.normalizeString(musicList.get(i).getTitle()));
                    musicViewHolder.artist.setText(AudioUtil.normalizeString(musicList.get(i).getArtist()));
    ...
    private String loadText(String saved_text, View v) {
        SharedPreferences sPref = v.getContext().getSharedPreferences(SettingsGeneralActivity.SPreferences, MODE_PRIVATE);
