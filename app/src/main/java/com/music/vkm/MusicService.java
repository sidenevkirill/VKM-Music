...
public class MusicService extends Service {
    ...
    public static Music_Schedule cachedMusic = new Music_Schedule();
    ...
    public void onCreate() {
        ...
        Intent activityIntent = new Intent(getApplicationContext(), AP_Main.class);
    ...
    public void SendInfo() {
        ...
        in.putExtra("your", wstr.normalizeString(schedule.getCurrentMusic().getYour()));
        in.putExtra("title", wstr.normalizeString(schedule.getCurrentMusic().getTitle()));
        in.putExtra("artist", wstr.normalizeString(schedule.getCurrentMusic().getArtist()));
        in.putExtra("pic", wstr.normalizeString(schedule.getCurrentMusic().getPic()));
    ...
    public void setMusicList(Music_Schedule newSchedule) {
    ...
    public static Music_Schedule getSchedule() {
        return schedule;
    }

    //save and get music info
    public void saveMusicInfo(Music music) {
        Music_Schedule music_schedule = getMusicInfo();
    ...
    public static Music_Schedule getCachedMusic() {
        return cachedMusic;
    }
    ...
    public static void setCachedMusic(Music_Schedule music) {
        cachedMusic = music;
    }
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, final Response response) throws IOException {
                ...
                if (responseData.contains("<!json>[]<!>")) {
                    ...
                    musicurl = "https://vk.com/mp3/audio_api_unavailable.mp3?extra=" + wstr.pars("https:\\/\\/vk.com\\/mp3\\/audio_api_unavailable.mp3?extra=", responseData, "\"");
                }
