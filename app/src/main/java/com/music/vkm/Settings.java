    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener chbox1click = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (loadText("smAll").equals("true")) {
                    ...
                    Toast.makeText(Settings.this, getResources().getString(R.string.smAllEx), Toast.LENGTH_LONG).show();
                    saveText("smAll", "true");
                }
        ...
        full.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                View view = View.inflate(Settings.this, R.layout.setpath_dialog, null);
                final AlertDialog.Builder builder = new AlertDialog.Builder(Settings.this, R.style.AlertDialog);
            ...
            public void onClick(View v) {
                ...
                builder.setNeutralButton(getResources().getString(R.string.setdefault), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Uri destinationUri = Uri.parse(Environment.getExternalStorageDirectory().toString() + Audio_main_activity.path);
                ...
                if (getListMusic(destinationUri.getEncodedPath()).size() > 0 || getListMusic(destinationUriOld.getEncodedPath()).size() > 0) {
                    ...
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Uri output = Uri.parse(Environment.getExternalStorageDirectory().toString() + Audio_main_activity.path);
...
*/
    ...
    public void Click(View view) {
        Intent intent = new Intent(Settings.this, Audio_main_activity.class);
        startActivityForResult(intent, 1);
    }
}
