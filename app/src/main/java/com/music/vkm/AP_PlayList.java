...
public class AP_PlayList extends Fragment {
    ...
    public static AP_PlayList newInstance(String text) {

        AP_PlayList f = new AP_PlayList();
        Bundle b = new Bundle();
    ...
    public void setRV() {
        ...
        final AdapterMusic adapter = new AdapterMusic(MusicService.getSchedule().getPlaylist(), new ArrayList<PlayList>(), 5);
